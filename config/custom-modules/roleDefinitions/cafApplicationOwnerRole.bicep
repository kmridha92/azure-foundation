...
var varRole = {
  name: '[${managementGroup().name}] Application Owner (DevOps, App operations)'
  description: 'Contributor role for the application or operations team at the subscription scope'
}
